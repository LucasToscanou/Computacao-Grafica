...
static void initialize (void)
{
  ...
  glCullFace(GL_BACK);  // Cull back faces (default setting)
glFrontFace(GL_CCW);  // Set counter-clockwise as front-facing (OpenGL default)
  ...
  AppearancePtr earthTex = Texture::Make("textureSampler", "../images/earth.jpg");
  AppearancePtr woodTex = Texture::Make("textureSampler", "../images/wood.jpg");
  AppearancePtr brickTex = Texture::Make("textureSampler", "../images/brick.jpg");
  AppearancePtr timberTex = Texture::Make("textureSampler", "../images/earth.jpg");
  ...
  trf_sphere1->Translate(0.2f,0.35f,-0.2f);
  ...
  trf_cylinder->Translate(-0.75f,0.5f,0.75f);
  ...
  // Cylinder
  CylinderPtr cylinder = Cylinder::Make();
  ...
  NodePtr root = Node::Make(shd_tex,
    {
      Node::Make(trf_table,{woodTex, white},{table}),
      Node::Make(trf_block,{white, brickTex},{block}),
      Node::Make(trf_sphere2,{earthTex, white},{sphere2}),
      Node::Make(trf_sphere1,{green, brickTex},{sphere1}),
      Node::Make(trf_cylinder,{timberTex, white},{cylinder})
    }
  );
